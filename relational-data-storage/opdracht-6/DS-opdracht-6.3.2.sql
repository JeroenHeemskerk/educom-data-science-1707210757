SELECT name , HTML_UnEncode(name) AS nice_name
FROM mhl_suppliers
WHERE name LIKE '%&%;%'
LIMIT 25

/*  Function found online (at https://stackoverflow.com/questions/3678980/is-there-a-mysql-function-to-decode-html-entities)
    which replaces html characters. No easy function to do it automatically, need to check for all possibilities 
